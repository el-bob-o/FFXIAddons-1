...
React 1.6.0.0.1 - added stunactor command. Will try to inject an action to cast stun spell on actor if job or subjob is DRK or BLM. This is so that you can stun an actor that is not your target. Only in ready phase.
