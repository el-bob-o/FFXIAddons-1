...
MasterGearList = {
	...
	ammo = {
		...
		{ name = "Seeth. Bomblet +1", 	setList = { { job = "RUN", sets = { "Resolution" } } } },
	...
	head = {
		...
		{ name = "Despair Helm",		setList = { { job = "RUN", sets = { "Emnity" } } }, 
			priority = 46 },
		{ name = "Herculean Helm",		setList = { { job = "RUN", sets = { "Dimidiation", "Resolution" } },
	...
	neck = {
		...
		{ name = "Futhark Torque +1",	setList = { { job = "RUN", sets = { "DT", "Hybrid", "Emnity" } } },
			priority = 30 },
		{ name = "Fotia Gorget",		setList = { { job = "RUN", sets = { "Resolution" } },
	...
	ear1 = {
		...
		{ name = "Ethereal Earring",	setList = { { job = "RUN", sets = { "DT" } } },
			priority = 15 },
		{ name = "Cessance Earring",	setList = { { job = "RUN", sets = { "Hybrid", "Dimidiation", "Resolution" } },
													{ job = "THF", sets = { "Hybrid", "Rudra's Storm", "Evisceration", } },
													} },
	...
	ear2 = {
		...
		{ name = "Etiolation Earring",	setList = { { job = "RUN", sets = { "MDT", "Fastcast" } },
			...
			priority = 110 },
		{ name = "Brutal Earring",		setList = { { job = "RUN", sets = { "Hybrid", "Resolution" } },
													{ job = "THF", sets = { "Hybrid" } }
													} },
		{ name = "Hecate's Earring",	setList = { { job = "RUN", sets = { "Lunge" } },
													{ job = "THF", sets = { "Aeolian Edge" } },
													} },
		{ name = "Odr Earring",			setList = { { job = "RUN", sets = { "Dimidiation" } },
	...
	body = {
		...
		{ name = "Futhark Coat +3", 	setList = { { job = "RUN", sets = { "DT", "Elemental Sforzo", "Liement", "Dimidiation", "Resolution", "IdleRegen" } } },
			priorty = 119 },
		...
		{ name = "Pillager's Vest +2", 	setList = { { job = "THF", sets = { "Hide", "Rudra's Storm", "Evisceration" } } } },
	},
	hands = {
		...
		{ name = "Leyline Gloves", 		setList = { { job = "RUN", sets = { "Fastcast","Lunge" } },
			...
			priorty = 25 },
		{ name = "Meg. Gloves +2", 		setList = { { job = "RUN", sets = { "PDT", "Dimidiation", "Resolution" } },
													{ job = "THF", sets = { "Hybrid", "Rudra's Storm" } },
													},
			priorty = 30 },
	...
	ring1 = {
		...
		{ name = "Rajas Ring",			setList = { { job = "RUN", sets = { "Dimidiation", "Resolution" } },
	...
	ring2 = {
		...
		{ name = "Rufescent Ring",		setList = { { job = "RUN", sets = { "Resolution" } } } },
	},
	back = {
	...
	waist = {
		...
		{ name = "Fotia Belt",			setList = { { job = "RUN", sets = { "Resolution" } },
													{ job = "THF", sets = { "Evisceration" } },
													} },
		{ name = "Sailfi Belt +1",		setList = { { job = "RUN", sets = { "Hybrid", "Dimdiation", } },
													{ job = "THF", sets = { "Hybrid", "Rudra's Storm" } },
													} },
	},
	legs = {
		...
		{ name = "Futhark Trousers +1",	setList = { { job = "RUN", sets = { "Valiance", "FastcastEnhancing" } } },
			priority = 87 },
		{ name = "Meg. Chausses +2",	setList = { { job = "RUN", sets = { "Hybrid", "Dimidiation", "Resolution" } },
													{ job = "THF", sets = { "Hybrid" } }
													},
			priority = 35 },
		{ name = "Rawhide Trousers",	setList = { { job = "RUN", sets = { "Fastcast" } },
			...
			priority = 35 },
		{ name = "Pill. Culottes +2",	setList = { { job = "THF", sets = { "Rudra's Storm", "Evisceration" } } } },
	},
	feet = {
		...
		{ name = "Futhark Boots +1",	setList = { { job = "RUN", sets = { "Rayke" } } },
			priority = 13 },
		{ name = "Herculean Boots",		setList = { { job = "RUN", sets = { "Hybrid", "Lunge" } },
													{ job = "THF", sets = { "Aeolian Edge" } }
													},
			priority = 9 },
		{ name = "Lustra. Leggings +1",	setList = { { job = "RUN", sets = { "Dimidiation", "Resolution" } },
													{ job = "THF", sets = { "Rudra's Storm" } }
													},
			priority = 12 },
