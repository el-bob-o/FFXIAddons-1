...
MasterGearList = {
	...
	head = {
		...
		{ name = "Malignance Chapeau",	setList = { { job = "THF", sets = { "Hybrid" } },
													{ job = "NIN", sets = { "Hybrid" } },
													{ job = "RNG", sets = { "RangedIdleDT", "MeleeHybrid" } },
													} },
	...
	ear1 = {
		...
		{ name = "Odnowa Earring +1",	setList = { { job = "RNG", sets = { "RangedIdleDT" } }, } },
	},
	ear2 = {
		...
		{ name = "Etiolation Earring",	setList = { { job = "RUN", sets = { "MDT", "Fastcast" } },
													{ job = "THF", sets = { "Fastcast" } },
													{ job = "NIN", sets = { "Fastcast" } },
													{ job = "RNG", sets = { "RangedIdleDT", "Fastcast" } },
													},
			priority = 110 },
	...
	body = {
		...
		{ name = "Malignance Tabard", 	setList = { { job = "THF", sets = { "Hybrid" } },
													{ job = "NIN", sets = { "Hybrid" } },
													{ job = "RNG", sets = { "RangedIdleDT", "MeleeHybrid", "Midshot" } },
													} },
	...
	legs = {
		...
		-- { name = "Arc. Braccae +2",	 	setList = { { job = "RNG", sets = { "AGI_Ranged_WS" } } } },
		{ name = "Orion Braccae +2",	 setList = { { job = "RNG", sets = { "Flurry2" } } } },
		-- { name = "Plunderer Culottes +2",	setList = { { job = "THF", sets = { "Rudra's Storm", "Savage Blade", "Requeiescat" } } } },
		{ name = "Nyame Flanchard",	 	setList = { { job = "RUN", sets = { "DT", "Lunge" } },
	...
	feet = {
		...
		{ name = "Erilaz Greaves +1",	setList = { { job = "RUN", sets = { "PDT", "Emnity" } } },
			priority = 18 },
		{ name = "Nyame Sollerets",		setList = { { job = "RUN", sets = { "Hybrid", "Lunge", "Requiescat" } },
													{ job = "THF", sets = { "Aeolian Edge", "Requiescat" } },
													{ job = "NIN", sets = { "MagicAtk", "STR_WS", "DEX_WS" } },
