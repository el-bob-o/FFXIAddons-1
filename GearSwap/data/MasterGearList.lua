...
MasterGearList = {
	...
	ear1 = {
		...
		{ name = "Lugalbanda Earring", 	setList = { { job = "SMN", sets = { "BPDmg" } } } },
	...
	body = {
		...
		{ name = "Cohort Cloak +1", 	setList = { { job = "GEO", sets = { "MACC" } },
			...
			priority = 91 },
		{ name = "Meg. Cuirie +2", 		setList = { { job = "RNG", sets = { "STR_Melee_WS" } } } },
		{ name = "Amini Caban +1", 		setList = { { job = "RNG", sets = { "Flurry2" } } },
			priority = 57 },
		{ name = "Arc. Jerkin +3",	 	setList = { { job = "RNG", sets = { "Double Shot", "AGI_Ranged_WS" } } },
			priority = 79 },
	...
	back = {
		...
		{ name = "Belenus's Cape",		setList = { { job = "RNG", sets = { "Melee Hybrid", "Midshot", "Doubleshot", "IdleRegen", "RangedIdleDT" } } },
	...
	legs = {
		...
		{ name = "Meg. Chausses +2",	setList = { { job = "THF", sets = { "Hybrid" } },
			...
			priority = 35 },
		{ name = "Gleti's Breeches",	setList = { { job = "THF", sets = { "IdleRegen", "Evisceration" } } } },
		{ name = "Arc. Braccae +2",	 	setList = { { job = "RNG", sets = { "Eagle Eye Shot", "AGI_Ranged_WS" } } },
			priority = 77 },
	...
	feet = {
		...
		{ name = "Meg. Jam. +2", 		setList = { { job = "RNG", sets = { "Flurry1", "AGI_Ranged_WS" } } },
			priority = 20 },
		{ name = "Arcadian Socks +2",	setList = { { job = "RNG", sets = { "Flurry2" } } },
			priority = 23 },
