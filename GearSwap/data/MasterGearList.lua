...
MasterGearList = {
	...
	neck = {
		...
		{ name = "Marked Gorget",		setList = { { job = "RNG", sets = { "Midshot", "AGI_Ranged_WS" } }, } },
	...
	ear2 = {
		...
		{ name = "Ishvara Earring",		setList = { { job = "RNG", sets = { "AGI_Ranged_WS", "STR_Melee_WS" } }, } },
	},
	body = {
	...
	hands = {
		...
		{ name = "Meg. Gloves +2", 		setList = { { job = "RUN", sets = { "Dimidiation", "Resolution", "Requiescat", "Savage Blade" } },
													...
													{ job = "RNG", sets = { "Hybrid", "AGI_Ranged_WS", "STR_Melee_WS" } },
													},
			priorty = 30 },
	...
	ring1 = {
		...
		{ name = "Rajas Ring",			setList = { { job = "RUN", sets = { "Dimidiation", "Resolution", "Savage Blade" } },
													...
													{ job = "NIN", sets = { "STR_WS", "DEX_WS" } },
													{ job = "RNG", sets = { "Midshot", "STR_Melee_WS" } },
													} },
	...
	ring2 = {
		...
		{ name = "Apate Ring",			setList = { { job = "RNG", sets = { "Midshot", "AGI_Ranged_WS", "STR_Melee_WS" } },
													} },
	...
	legs = {
		...
		-- { name = "Arc. Braccae +2",	 	setList = { { job = "RNG", sets = { "AGI_Ranged_WS", "MagicAtk" } } } },
	...
	feet = {
		...
		{ name = "Herculean Boots",		setList = { { job = "RUN", sets = { "Hybrid", "Lunge", "Requiescat" } },
													...
													{ job = "RNG", sets = { "MagicAtk", "STR_Melee_WS" } },
													},
			priority = 9 },
